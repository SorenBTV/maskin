...
plt.ylabel("MSE")
plt.savefig(os.path.join(output_dir, "MSE_OLS_franke.pdf"))
#plt.show()
...
plt.xlabel("Polynomial degree")
plt.ylabel("$R^2$")
plt.savefig(os.path.join(output_dir, "R2_score_franke.pdf"))
#plt.show()
...
plt.ylabel(r"$\beta_i$")
plt.grid()
plt.savefig(os.path.join(output_dir, "B_franke.pdf"))
#plt.show()
